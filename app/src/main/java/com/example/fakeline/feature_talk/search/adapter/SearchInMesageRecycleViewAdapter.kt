...
class SearchInMesageRecycleViewAdapter(
    private val context : Context,
    private val messageList: MutableList<FakeMessages>
) :
    RecyclerView.Adapter<SearchInMesageRecycleViewAdapter.messageViewHolder>() {
    ...
    inner class messageViewHolder(view: View) : RecyclerView.ViewHolder(view){
        ...
        var mMessageInfoConstraintLayout =view.findViewById<ConstraintLayout>(R.id.messageInfoConstraintLayout)
        fun bind(position: Int){
            ...
            mMessageInfoConstraintLayout.setOnClickListener {
                mOnItemCheckListener?.onCheck(position,mMessageList[position].keyword)
            }
        }
    }
    ...
    interface OnItemCheckListener {
        fun onCheck(position:Int,keyword:String)
    }
